                ...
                <c:forEach items="${categoryCustomList}" var="c">
                    <c:if test="${c.categoryPid==0}">
                        <tr>
                            ...
                            <td>
                                <a href="/admin/category/up/${c.categoryId}" class="layui-btn layui-btn-danger layui-btn-mini">上移</a>
                                <a href="/admin/category/down/${c.categoryId}" class="layui-btn layui-btn-danger layui-btn-mini">下移</a>
                        ...
                        <c:forEach items="${categoryCustomList}" var="c2">
                            <c:if test="${c2.categoryPid==c.categoryId}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="/admin/category/up/${c2.categoryId}" class="layui-btn layui-btn-danger layui-btn-mini">上移</a>
                                        <a href="/admin/category/down/${c2.categoryId}" class="layui-btn layui-btn-danger layui-btn-mini">下移</a>
