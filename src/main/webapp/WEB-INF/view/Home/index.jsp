                ...
                <div id="container">
                    <div id="list">
                        <div class="selected"> <a href="/aboutSite"
                            ...
                            <p class="slider-caption">Welcome to the blog of Hebh1!</p>
                        </div>
                        <div> <a href="/aboutSite"
                                 target="_blank" rel="external nofollow">
                            <img src="/img/lunboImg/2.jpg"
                                 alt="Welcome to the blog of Acamy!"></a>
                            <p class="slider-caption">Welcome to the blog of Hebh2!</p>
                        </div>
                        <div> <a href="/aboutSite"
                                 target="_blank" rel="external nofollow">
                            <img src="/img/lunboImg/3.jpg"
                                 alt="Welcome to the blog of Acamy!"></a>
                            <p class="slider-caption">Welcome to the blog of Hebh3!</p>
                        </div>
                    </div>
                    <div id="buttons">
