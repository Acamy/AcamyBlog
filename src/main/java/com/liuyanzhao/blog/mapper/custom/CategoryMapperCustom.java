...
public interface CategoryMapperCustom {
	...
	public Integer countPreCategoryByIdAndPid(
			@Param(value="id") Integer id,
			@Param(value="pid") Integer pid) throws Exception;

	public Category getPreCategoryByIdAndPid(
			@Param(value="id") Integer id,
			@Param(value="pid") Integer pid) throws Exception;

	public Integer countPostCategoryByIdAndPid(
			@Param(value="id") Integer id,
			@Param(value="pid") Integer pid) throws Exception;

	public Category getPostCategoryByIdAndPid(
			@Param(value="id") Integer id,
			@Param(value="pid") Integer pid) throws Exception;

	public void updateCategoryId(
			@Param(value="oldId") Integer oldId,
			@Param(value="newId") Integer newId) throws Exception;

	public void updateCategoryPId(
			@Param(value="oldId") Integer oldId,
			@Param(value="newId") Integer newId) throws Exception;
