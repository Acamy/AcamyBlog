...
public class BackCategoryController {
    ...
    public String upCategory(@PathVariable("id") Integer id) throws Exception {

        categoryService.upCategory(id);
    ...
    public String downCategory(@PathVariable("id") Integer id) throws Exception {

        categoryService.downCategory(id);
